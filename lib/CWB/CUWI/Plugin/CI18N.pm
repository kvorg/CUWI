...
sub register {
  ...
  $app->hook(
    before_dispatch => sub {
      ...
      # Handler
      $self->stash->{i18n}
        = CWB::CUWI::Plugin::CI18N::_Handler->new(namespace => $namespace);
...
package CWB::CUWI::Plugin::CI18N::_Handler;
use Mojo::Base -base;
...
CWB::CUWI::Plugin::CI18N - Internationalization plugin
...
This is a copy of L<Mojolicious::Plugin::I18N> as it existed in versions prior to Mojolicious 3.0.

It adds L<Locale::Maketext> support to L<Mojolicious>. All you have to
do besides using this plugin is to add as many lexicon classes as you
need. Languages can usually be detected automatically from the
C<Accept-Languages> request header. The code of this plugin is a good
...
L<CWB::CUWI::Plugin::CI18N> supports the following options.

=head2 C<default>

  # Mojolicious::Lite
  plugin CI18N => {default => 'en'};
...
=head2 C<namespace>
  ...
  # Mojolicious::Lite
  plugin CI18N => {namespace => 'MyApp::I18N'};

Lexicon namespace, defaults to the application class followed by C<::I18N>.

=head1 HELPERS

L<CWB::CUWI::Plugin::CI18N> implements the following helpers.
...
L<CWB::CUWI::Plugin::CI18N> inherits all methods from L<Mojolicious::Plugin>
